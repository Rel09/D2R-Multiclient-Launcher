...
void                                UI::Render() {
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(0.28f, 0.56f, 0.89f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.28f, 0.56f, 0.89f, 1.00f);
    ...
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.38f, 0.38f, 0.38f, 1.00f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.28f, 0.56f, 0.89f, 1.00f);
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.36f, 0.65f, 1.00f, 1.00f);
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.46f, 0.75f, 1.00f, 1.00f);
    colors[ImGuiCol_Tab] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.28f, 0.56f, 0.89f, 1.00f);
    colors[ImGuiCol_TabActive] = ImVec4(0.36f, 0.65f, 1.00f, 1.00f);
    ...
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.28f, 0.56f, 0.89f, 0.35f);
    colors[ImGuiCol_DragDropTarget] = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
    colors[ImGuiCol_NavHighlight] = ImVec4(0.28f, 0.56f, 0.89f, 1.00f);
    colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
